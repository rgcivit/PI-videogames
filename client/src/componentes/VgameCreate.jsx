...
import {  useDispatch, useSelector } from "react-redux";
 ...
 export default function VgameCreate(){
    ...
    console.log(genres, 'hola soy genre')
        ...
        <div>
            ...
            <form onSubmit={(e)=> handleSubmit(e)}>
                ...
                <div>
                    ...
                    onChange={(e)=>handleChange(e)}
                    />
                    {errors.description && (<p className='error' color='red'>{errors.description}</p>
                    )}
                </div>
                <div>
                    ...
                    onChange={(e)=>handleChange(e)}
                    />
                    {errors.released && (<p className='error'  color='red'>{errors.released}</p>
                    )}
                </div>
                <div>
                    <label>Imagen:</label>
                ...
                <div>
                    ...
                    onChange={(e)=>handleChange(e)}
                    />
                    {errors.rating && (<p className='error'  color='red'>{errors.rating}</p>
                    )}
                </div>
                <label>Género:</label>
                ...
                <li>{input.platforms.map(el=>el.platform + ' ,')}</li>
                <br />
                <br />
